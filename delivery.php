...
<body>
    ...
    <div class="header text-center py-4 bg-info">
        <h1 class="text-white">Bullseye Delivery Report</h1>
    </div>
    ...
    <script>
        ...
        function buildTable(text) {
            ...
            html += "<tr><th scope='col'>Order ID</th><th scope='col'>Pick up</th><th scope='col'>Deliver To</th><th scope='col'>Status</th>";            
            ...
            html += "<td>" + row.SiteFrom + "</td>";
            html += "<td>" + row.SiteTo + "</td>";
        ...
        let url = `api/deliveryByDate.php?startDate=${startDate}&endDate=${endDate}`;
        let method = "GET";
        let xhr = new XMLHttpRequest();
        xhr.onreadystatechange = function () {
            if (xhr.readyState === XMLHttpRequest.DONE) {
